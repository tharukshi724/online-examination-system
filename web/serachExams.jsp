...
<div class="container">
    <div class="content">
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav__item">
                    <a href="#" class="side-nav__link">
                        ...
                        <div class="side-nav__text">Search Exams</div>
                    </a>
                </li>
        ...
        <div class="main-content">
            ...
            <h1></h1>
            <h2>Enter subject and Exam type to load exams</h2>
<div class="container1">
    <form method="post" class="form" action="<%=request.getContextPath()%>/GetPaperServlet">
